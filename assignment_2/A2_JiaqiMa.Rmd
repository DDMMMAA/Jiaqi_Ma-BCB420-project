...
`496` significant pathway/geneset were identified within in all significant genes; `112` significant pathway/geneset were identified within up-regulated genes; `579` significant pathway/geneset were identified within down-regulated genes; Note the number of significant pathway identified in down-regulated genes is more than all significant genes.
...
# 2. Export the bulletproof .rnk file to your working directory
write.table(gsea_rnk, 
            file = "A2_JiaqiMa.rnk", 
            sep = "\t", 
...
cat("Successfully generated A2_JiaqiMa.rnk with", nrow(gsea_rnk), "unique genes.\n")
head(gsea_rnk)
...
![Figure 3: Scrennshot of GSEA parameters](figure/gsea_param.png)
