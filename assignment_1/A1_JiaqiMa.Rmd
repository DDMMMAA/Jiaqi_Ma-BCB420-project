...
# Save resulting Seurat object and DEG list

To avoid Assignment #2 inherits the limited RAM issue by re-run all Assignment #1, save resulting `Seurat object` and `DEG list` to disk for Assignment #2 to read.
